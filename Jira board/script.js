...
function addTask(){
    ...
    card.focus(); //it means pointer is automatically there for to write
    //pointer will be  in editable jone  automatically

    //problem:1 empty card should be removed

    //blur means focus lost
